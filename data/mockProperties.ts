export interface Property {
  ...
  imageAlt: string;
  tag: string;
  tagColor?: "white" | "mosque" | "nordic-dark"; // Using semantic keys
  isFavorite?: boolean;
}
...
export const newMarketProperties: Property[] = [
  ...
  },
  {
    ...
    location: "88 Tech Way, Palo Alto",
    price: "$4,100,000",
    beds: 4,
    baths: 3.5,
    area: "320m²",
  ...
  },
  {
    ...
    location: "777 Sand Dune, Scottsdale",
    price: "$1,250,000",
    beds: 3,
    baths: 3,
    area: "240m²",
  ...
  },
  {
    ...
    location: "12 Cobblestone Ln, Boston",
    price: "$950,000",
    beds: 3,
    baths: 2,
    area: "160m²",
  ...
  },
  {
    ...
    location: "50 Green Pasture, Nashville",
    price: "$2,800,000",
    beds: 5,
    baths: 4.5,
    area: "550m²",
